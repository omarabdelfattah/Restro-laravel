        ...
        <div class="collapse navbar-collapse collapse show" id="navbarSupportedContent1">
            <ul class="navbar-nav" style="margin: auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ Route('landing') }}" style="margin-left: 60px;">All <span
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{ Route('cat',$cat['id']) }}"
                        style="margin-left: 60px;">{{ $cat['name'] }}</a>
                </li>
                @endforeach
        ...
        <div class="row justify-content-center text-left">
            ...
            <div class="card col-md-3 text-center" style="margin: 20px">
                ...
                <input type="hidden" name="product_id" value="{{ $meal->id }}" />
                    @csrf
                    <img class="card-img-top" src="{{asset("assets/imgs/products/". $meal->image)}}"
                        alt="Card image cap" style="margin-top : 20px; height:195px; width:252px;">
                    <div class="card-body">
                        ...
                        <p class="card-text" style="margin: 20px;">{{ $meal->price }} $ <input name="quantity" type="number" value="1"
                                min="1" max="1000" step="1" class="spinner" style="width: 50%;" /> </p>
